...
export default function Home() {
  // DEV-ONLY: Internal ML Bridge Initialization
  // console.log("Initializing ML engine... [sk2d_generator_latest.pth]");
  ...
  const handleSketchComplete = async (canvas: HTMLCanvasElement) => {
    ...
    setProcessingStep("Inference: SketchEncoder-v5 (PyTorch CUDA)...")
    ...
    setProcessingStep("Computing Poisson Reconstruction & Mesh Refinement...")
